...
import { MarqueTypes, VoitureTypes ,FetchError,_ModeleTypes,ImageTypes} from "../../../types";
...
const VoitureView = () => {
  ...
  const [vehiculeImages, setVehiculeImages] = useState<ImageTypes[]>([]);
  ...
  function handleDelete(imageId:number, photo:string) {
    setPhotoId(imageId);
    setImage(photo);
    setOpenDelete(true);
  }
  ...
  const getVehiculeName = (vehicule:VoitureTypes) => {
                  ...
                  {({
                    ...
                    <Form
                      ...
                      onSubmit={(e) => {
                        ...
                        ApiService.updateVoiture(Number(id), formData, userToken)
                          .then((res) => res.json())
                          .then((data) => {
                            console.log(data);
                      ...
                      <Box sx={{ p: 2 }}>
                        ...
                        <Box>
                          ...
                          >
                            ...
                            <Box className={classes.boxWrapper}>
                              ...
                              <TextField
                                select
                                value={marque}
                                onChange={(e) => setMarque(Number(e.target.value))}
                              >
                                {marques?.map((marque) => (
                          ...
                          >
                            ...
                            <Button
                              disabled={Boolean(!dirty) || Boolean(!isValid)}
                              color="info"
                              variant="contained"
                              type={"submit"}
                            >
                ...
                <Box height={"100%"} overflow={"auto"}>
                  ...
                  <PreviewImage
                    ...
                    onNewImages={(newImages) => {
                      setVehiculeImages(newImages.images);
                    }}
