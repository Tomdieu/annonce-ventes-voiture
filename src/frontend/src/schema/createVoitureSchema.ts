...
export default yup.object().shape({
    annee: yup.number().required("Annee de sortie obligatoire").min(1994, "L'annee doit extre superieur or egale a  1994").max(new Date().getFullYear(), `L'annee doit etre inferieur ou egale a l'annee courante ${year}`),
