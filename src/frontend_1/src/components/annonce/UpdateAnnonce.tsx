...
type Props = {
    ...
    onUpdate: (data: AnnonceTypes) => void;
    annonceId: number;
};
...
const SingletonUpdateAnnonce = (props: Props) => {
    const { open, onClose, onUpdate, annonceId } = props;
    ...
    useEffect(() => {
        setLoading(true)
        if (annonceId) {
            ApiService.getAnnonce(annonceId, userToken)
                .then(res => res.json())
                .then((data) => {
                    setAnnonce(data)
                    console.log(data)
                    ...
                    setAnnonceLocation({ ...annonceLocation, longitude: data.longitude, latitude: data.latitude })
                    setLoading(false);
    ...
    return (
        ...
        >
            ...
            {!loading && <Formik
                initialValues={{ ...annonce, voiture: annonce.voiture.id }}
                ...
                {({
                    ...
                    <Form
                        ...
                        onSubmit={(e) => {
                            ...
                            ApiService.updateAnnonce(annonceId,jsonString, userToken)
                                .then((res) => res.json())
                                .then((data) => {
                                    console.log(data);
                                    onUpdate(data)
...
const UpdateAnnonce = (props: Props) => <SingletonUpdateAnnonce {...props} />;

export default (props: Props) => <UpdateAnnonce {...props} />;
