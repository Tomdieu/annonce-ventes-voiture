    ...
    return (
        <Card key={annonce.titre} className={classes.card}>
            ...
            <Typography variant="body2" color="textSecondary">
                Voiture : {annonce.voiture.model.marque.nom} {annonce.voiture.model.nom}  {annonce.voiture.anneee}
            </Typography>
            <Typography variant="body2" color="textSecondary">
            ...
            <Box sx={(theme) => ({ position: 'absolute', left: 5, top: -30, backgroundColor: "#84b7f1c9", borderRadius: theme.shape.borderRadius, p: theme.spacing(.5) })}>
                ...
                <Typography variant="body2" color="textSecondary" sx={{display:"flex",alignItems:"center",gap:5}}>
                    <BsClock/>
